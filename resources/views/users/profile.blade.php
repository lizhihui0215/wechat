            ...
            <div class="row m-b-lg m-t-lg">
                <div class="col-md-6">
                    ...
                    <div class="profile-image">
                        <img src="{{$profile->small_profile_image}}" class="img-circle circle-border m-b-md" alt="profile">
                    </div>
                ...
                <div class="col-md-3">
                    ...
                    <div id="sparkline1"><canvas width="215" height="50" style="display: inline-block; width: 215px; height: 50px; vertical-align: top;"></canvas></div>
                </div>
